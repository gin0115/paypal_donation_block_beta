...
function Edit(props) {
  const {
    ...
    setAttributes,
    name
  } = props; // Get the arguments from PHP register block array
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)('team51/paypal-donations-block', {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkteam51_paypal_donation_block"] = self["webpackChunkteam51_paypal_donation_block"] || [];
